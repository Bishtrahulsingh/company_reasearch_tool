...
async def retrieve(client:AsyncQdrantClient,collection_name:str,query:str, company:str,score_threshold:float=0.0,top_k:int=20):
    #embed query
    #dense embedding
    ...
    filtered_chunks = await filter_chunks_by_company_name(client=client,collection_name=collection_name,query_vector=query_vector,score_threshold=score_threshold,top_k=top_k,company=company,sparse_vector=sparse_vector)
